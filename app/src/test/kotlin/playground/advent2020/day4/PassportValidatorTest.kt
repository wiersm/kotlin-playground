...
class PassportValidatorTest {
    @Test fun `should count passports without field validation`() {
        val input = sequenceOf("ecl:gry pid:860033327 eyr:2020 hcl:#fffffd",
    ...
    @Test fun `should not count passports with invalid values`() {
        val input = sequenceOf("eyr:1972 cid:100",
    ...
    @Test fun `should count passports with valid values`() {
        val input = sequenceOf("pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980",
            "hcl:#623a2f",
            "",
